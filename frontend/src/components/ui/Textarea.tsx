    ...
    return (
      <textarea
        className={cn(
          ...
          variant === "minimal" && "min-h-[64px] h-[64px] max-h-[160px] bg-muted/5 border-border rounded-2xl px-6 py-4 transition-all resize-none scrollbar-none overflow-hidden text-[13px] leading-relaxed font-medium focus-visible:ring-primary/20",
          className
        )}
        ref={ref}
        {...props}
